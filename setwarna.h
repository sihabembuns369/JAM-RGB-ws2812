...
<body>
            ...
            <div class="column">
                <div class="card">
                    ...
                    <form action="/aturwarna" method="post">
                     ...
                     <br> 
                         <input type="radio" name="warnaa"  value="1">random</input></br>
                         <input type="radio" name="warnaa"  value="2">efek1</input></br>
                         <input type="radio" name="warnaa"  value="3">efek2</input></br>
                         <input type="radio" name="warnaa"  value="4">mix(campur)s</input></br>
    ...
    <script>
        function gantiwarna(){
         ...
         q = document.querySelector('input[name="warnaa"]:checked').value

 //        nocache = \"/&nocache=\" + Math.random() * 1000000;
    var request = new XMLHttpRequest();
    request.open("POST",+ p + q , false);
    request.send(null);
